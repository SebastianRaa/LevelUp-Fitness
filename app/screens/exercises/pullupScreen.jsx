...
const PullupScreen = ({ route }) => {
  return (
    <ScrollView style={styles.container}>
      <Text>
        <Text style={{ fontSize: 22 }}>Klimmzüge</Text>
        {"\n"}
        {"\n"}
      </Text>
      <Text>
        Level 1: Vertical Pulls (Vertikale Züge){"\n"}Anleitung:{"\n"}Suche dir
        eine stabile vertikale Fläche, z. B. einen Türrahmen oder ein Geländer.
        Stelle dich nah davor, greife es etwa schulterbreit und lehne dich nach
        hinten. Strecke die Arme fast vollständig, bis du eine Dehnung im Rücken
        spürst. Ziehe dich nun durch Anspannen der Schulterblätter und Beugen
        der Arme zurück. Halte den Körper angespannt und die Bewegung langsam
        und kontrolliert.{"\n"}
        ...
        Anleitung:{"\n"}Lege dich unter einen stabilen Tisch, greife die Kante
        schulterbreit im Obergriff. Spanne den Körper an, hebe ihn hoch, bis
        Brust und Tischkante sich berühren. Halte die Körperspannung während der
        gesamten Bewegung. Senke dich wieder kontrolliert ab. Diese Übung stärkt
        Rücken, Arme und Griffkraft.{"\n"}
        {"\n"}Trainingsziele:{"\n"}Anfänger: 1 Satz à 10 Wdh.{"\n"}
        Fortgeschritten: 2 Sätze à 20 Wdh.{"\n"}Level-Up: 3 Sätze à 30 Wdh.​
        {"\n"}
        {"\n"}Level 3: Jackknife Pullups (Klappmesser-Klimmzüge){"\n"}Anleitung:
        {"\n"}Hänge dich an eine hohe Stange, die vor einem Stuhl oder Tisch
        steht. Lege die Unterschenkel auf die Erhöhung. Ziehe dich nun an der
        Stange hoch und drücke dabei die Beine leicht in die Auflage, um
        Unterstützung zu erhalten. Sobald dein Kinn über die Stange reicht,
        halte kurz, senke dich dann langsam ab.{"\n"}
        {"\n"}Trainingsziele:{"\n"}Anfänger: 1 Satz à 10 Wdh.{"\n"}
        ...
        Bewegungsradius: obere Hälfte der Zugbewegung. Dies trainiert Griff,
        ...
        Fortgeschritten: 2 Sätze à 7 Wdh. pro Seite{"\n"}Level-Up: 2 Sätze à 9
        Wdh. pro Seite​{"\n"}
        {"\n"}Level 8: Half One-Arm Pullups (Halbe Einarm-Klimmzüge){"\n"}
        Anleitung:{"\n"}Greife die Stange mit nur einer Hand, dein Arm ist
        bereits 90 Grad gebeugt. Oberarm parallel zum Boden. Nimm die andere
        Hand hinter den Rücken. Spanne den ganzen Körper an, ziehe dich
        kontrolliert hoch, bis das Kinn über die Stange kommt. Senke dich dann
        wieder in die Startposition ab. Diese Variante bereitet auf echte
        Einarm-Klimmzüge vor.{"\n"}
        ...
        {"\n"}Anleitung:{"\n"}Greife die Stange mit einer Hand, in der anderen
        hältst du ein Handtuch ungefähr auf Augenhöhe, das ebenfalls über die
        Stange hängt. Ziehe dich mit beiden Armen hoch, aber entlaste das
        Handtuch nach und nach, bis du nur noch mit einer Seite arbeitest. Oben
        kurz halten, dann kontrolliert absenken.{"\n"}
        {"\n"}Trainingsziele:{"\n"}Anfänger: 1 Satz à 3 Wdh. pro Seite{"\n"}
        Fortgeschritten: 2 Sätze à 5 Wdh. pro Seite{"\n"}Level-Up: 2 Sätze à 7
        Wdh. pro Seite​{"\n"}
        {"\n"}Level 10: One-Arm Pullups (Einarmige Klimmzüge – Master Step)
        {"\n"}Anleitung:{"\n"}Hänge frei an der Stange mit nur einer Hand, der
        Körper ist komplett angespannt. Ziehe dich aus der Kraft des einen Arms
        kontrolliert nach oben, bis das Kinn über der Stange ist. Halte kurz,
        dann senke dich langsam und mit Muskelkontrolle wieder ab. Kein Schwung,
        keine Hilfen – nur pure Kraft.{"\n"}
